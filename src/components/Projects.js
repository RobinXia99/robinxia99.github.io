    ...
    <>
      <div className="project reveal">
        ...
        <div className="project_description_container">
          <p>
            Dear Nature is a social app where users can create & share maps and
            pin locations/findings as well as their favorite pictures.
            <br />
            <br />
            Maps can be locked and unlocked as you wish. Locations pinned to the
            map can be edited - icon, image and description.
          </p>
          <a
            href="https://github.com/RobinXia99/Dear-Nature"
            target={"_blank"}
            rel="noreferrer"
          >
            Source
      ...
      <div className="project mid reveal">
        ...
        <div className="project_description_container mid">
          <p>
            Food Track is an app made with the idea of spreading the awesomeness
            of Food Trucks because they are sometimes hard to find. Theyre also
          ...
          <a
            href="https://github.com/crystalii/Food-Truck"
            target={"_blank"}
            rel="noreferrer"
          >
            Source
      ...
      <div className="project reveal">
        ...
        <div className="project_description_container">
          <p>
            A movie database that lets the user discover new movies through
            detailed pages, search & filter as well as write reviews.
            <br />
            <br />
            This was a school project which means the shopping cart isn't
            functional.
          </p>
          <a
            href="https://github.com/RticRtic/webb-movie"
            target={"_blank"}
            rel="noreferrer"
          >
            Source
